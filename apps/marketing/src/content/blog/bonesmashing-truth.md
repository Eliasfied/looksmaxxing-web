---
title: Does Bonesmashing Work? The Honest Truth
description: Does bonesmashing work? We break down the science, real risks, and what users actually report. Get the honest answer before trying anything.
slug: bonesmashing-truth
primary_keyword: does bonesmashing work
cluster: bonesmashing-truth
pubDate: 2026-05-23
heroImage: /blog/bonesmashing-truth/1.webp
...
faq:
  ...
  - q: Is bonesmashing dangerous?
    a: Yes, there are real risks. These include nerve irritation or damage, TMJ dysfunction, microfractures, soft tissue injury, and potential facial asymmetry. The risk-to-benefit ratio is unfavorable compared to lower-risk alternatives like mewing, masseter training, and body fat reduction. Always consult a qualified medical professional before attempting it.
  - q: How long does bonesmashing take to show results?
    a: Proponents typically claim results over several months to a year of consistent practice. However, because most people combine this with other lifestyle changes, it is very difficult to attribute any specific change to bonesmashing alone. There is no established timeline based on controlled evidence.
  - q: What are safer alternatives to bonesmashing for improving jawline appearance?
    a: Reducing overall body fat percentage, consistent correct tongue posture (mewing), masseter muscle training through hard chewing or mastic gum, and correcting forward head posture are all lower-risk approaches with clearer anatomical rationale. Getting a facial analysis baseline through a tool like Aura can help identify which specific features are worth focusing on.
draft: false
---
...
![Anatomical diagram of jawbone layers and masseter muscle relevant to bone remodeling claims](/blog/bonesmashing-truth/2.webp)
...
![Comparison illustration showing how body fat and masseter muscle affect jawline definition](/blog/bonesmashing-truth/3.webp)
...
One underrated step before starting any facial improvement practice is getting an honest assessment of where you actually are. [Aura](https://app.aura-looksmaxxing.com) provides AI-based facial analysis including jawline scoring, hunter-eye detection, and a personalized breakdown of your facial features. Having a clear baseline makes it easier to evaluate whether any practice is actually producing results, rather than relying on motivated perception.
...
1. Use only light to moderate pressure, nothing that causes pain or visible bruising.
2. Keep sessions short, under three minutes per area.
3. Do not target areas near the eyes, temples, or directly over nerve exit points (infraorbital foramen beneath the eye socket, mental foramen near the chin).
4. Stop immediately if you experience numbness, persistent soreness, or any asymmetry in sensation.
5. Treat it as one minor variable among many, not a primary strategy.
...
If you want to improve your facial structure and definition, there are better-supported, lower-risk strategies available. Use [Aura](https://app.aura-looksmaxxing.com) to get an objective read on your current facial profile, then build a plan around the interventions that make sense for your specific features. That is a more useful starting point than blunt force.
