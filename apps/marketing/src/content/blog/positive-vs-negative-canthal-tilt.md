---
title: "Positive vs Negative Canthal Tilt: Full Guide"
description: Learn the difference between positive vs negative canthal tilt, how each affects your appearance, and what you can realistically do about it.
slug: positive-vs-negative-canthal-tilt
primary_keyword: positive vs negative canthal tilt
cluster: compare-canthal-tilt
pubDate: 2026-06-30
heroImage: /blog/positive-vs-negative-canthal-tilt/1.webp
...
readingTime: 8
related: [are-deep-set-eyes-attractive, how-to-fix-negative-canthal-tilt, hunter-eyes-vs-almond-eyes]
faq:
...
![Anatomy diagram of the eye showing medial and lateral canthus with canthal tilt angle reference lines](/blog/positive-vs-negative-canthal-tilt/2.webp)

## Side-by-Side Comparison

| Feature | Positive Canthal Tilt | Negative Canthal Tilt |
|---|---|---|
| Outer corner position | Above inner corner | Below inner corner |
| Typical angle | +3 to +8 degrees | -3 to -8 degrees (or more) |
| Perceived expression at rest | Alert, intense, engaged | Tired, sad, soft |
| Common descriptors | Almond, feline, hunter | Droopy, rounded, downturned |
| Changes with age? | Tends to decrease over time | Tends to worsen over time |
| Fixable non-surgically? | Partially, via makeup and style | Partially, via makeup and style |
...
3. **Use a face analysis tool** to get an objective read. [Aura](https://app.aura-looksmaxxing.com) includes canthal tilt detection and hunter-eye analysis as part of its full facial breakdown, which removes the guesswork from self-assessment.
...
![Cross-section diagram of the eye socket showing how orbital bone and canthal tendon determine canthal tilt](/blog/positive-vs-negative-canthal-tilt/3.webp)
