---
title: How to Tell If Your Maxilla Is Recessed
description: Learn how to tell if your maxilla is recessed using facial landmarks, bite analysis, and self-assessment methods. Practical, anatomy-based guidance.
slug: how-to-tell-if-maxilla-is-recessed
primary_keyword: how to tell if maxilla is recessed
cluster: how-to-diagnose
pubDate: 2026-08-02
heroImage: /blog/how-to-tell-if-maxilla-is-recessed/1.webp
...
faq:
  ...
  - q: Is a recessed maxilla the same as an underbite?
    a: Not exactly. An underbite means the lower teeth sit in front of the upper teeth when biting, which can result from a recessed maxilla, a protruding lower jaw, or both. Maxillary retrusion is a skeletal position, while an underbite is a dental relationship. They frequently occur together but are assessed separately.
  - q: Does a recessed maxilla affect breathing?
    a: It can. The maxilla forms part of the nasal floor and influences palate width. Underdevelopment or retrusion of the maxilla is associated with a narrower airway, higher rates of mouth breathing, and in some cases sleep-disordered breathing. An ENT or sleep specialist can assess airway involvement.
  - q: At what age does maxillary development stop?
    a: The maxilla continues to grow through adolescence, generally completing development in the mid-to-late teens for females and slightly later for males. Skeletal interventions like palate expansion are more effective before growth plates fuse, which is why early evaluation is often recommended if structural concerns are identified in younger patients.
draft: false
---
...
![Anatomical diagram of the maxilla bone and surrounding facial structures](/blog/how-to-tell-if-maxilla-is-recessed/2.webp)
...
For a structured external baseline, [Aura](https://app.aura-looksmaxxing.com) provides AI-based facial analysis that includes mid-face projection scoring, helping you understand how your maxillary area compares to facial harmony benchmarks before committing to any clinical consultation.

![Illustrated guide showing how to assess maxilla projection using lateral facial photo reference lines](/blog/how-to-tell-if-maxilla-is-recessed/3.webp)
...
For those who want a clearer picture of their overall facial structure while gathering information before a professional visit, [Aura](https://app.aura-looksmaxxing.com) offers detailed facial analysis including jawline and mid-face metrics that can inform the conversation with your provider.
