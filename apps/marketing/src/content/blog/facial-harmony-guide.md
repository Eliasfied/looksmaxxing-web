---
title: "Chin to Philtrum Ratio: The Complete Facial Harmony Guide"
description: Learn how the chin to philtrum ratio affects facial harmony, what ideal measurements look like, and how to assess and improve your own proportions.
slug: facial-harmony-guide
primary_keyword: chin to philtrum ratio
cluster: face-symmetry-harmony
pubDate: 2026-06-11
heroImage: /blog/facial-harmony-guide/1.webp
...
faq:
  ...
  - q: How long should the philtrum be?
    a: The ideal philtrum length is generally cited as 11 to 13 mm in women and 13 to 15 mm in men. Lengths above these ranges are associated with an aged or heavy midface appearance and can make the chin look relatively weak even when bone structure is adequate.
  - q: Can the chin to philtrum ratio be improved without surgery?
    a: Yes, to a degree. Reducing facial fat, adjusting beard shape, and correcting forward head posture can all improve how the lower face reads in photos and in person. These changes do not alter bone structure but influence the perception of proportion meaningfully. Injectable chin filler is a minimally invasive option that sits between lifestyle changes and surgery.
  - q: How does the facial convexity angle relate to chin projection?
    a: The facial convexity angle measures how forward or backward the chin sits relative to the forehead and nose in profile. A recessed chin increases facial convexity beyond the ideal 0 to 12 degree range, which makes the philtrum appear longer and the profile weaker. Improving chin projection, whether through posture, filler, or surgery, directly reduces excess facial convexity.
draft: false
---
...
1. **Adequate chin projection.** The chin tip sits at or slightly behind the lower lip vertical when viewed in profile, but not recessed behind the nasal base vertical.
2. **Short to moderate philtrum.** The upper lip does not appear elongated or drooping.
3. **Defined mandibular angle.** The jaw meets the neck at a relatively sharp angle rather than blending into a soft curve.
4. **Moderate facial convexity.** The profile is neither excessively concave nor convex.
5. **Forward maxillary position.** The midface does not appear sunken, which would make even a normal-length philtrum look long by comparison.
...
![Side profile comparison showing imbalanced versus ideal chin to philtrum ratio and facial convexity angle](/blog/facial-harmony-guide/2.webp)
...
If you want an objective starting point across all these metrics, [Aura](https://app.aura-looksmaxxing.com) analyzes your facial proportions using AI, including jawline scoring and eye spacing assessment, and returns a structured breakdown rather than a vague impression.
...
1. **Take a neutral-expression photo** in good, even lighting. Face the camera straight on. Avoid tilting your chin up or down, as this distorts vertical measurements.
2. **Identify the landmarks.** Mark (mentally or with a photo editing tool) the base of your nose (subnasale), the top of your upper lip (the vermillion border), and the lowest point of your chin (menton).
3. **Measure in pixels or millimeters.** The philtrum runs from subnasale to the top of the upper lip. The chin segment runs from the bottom of the lower lip to the menton.
4. **Calculate the ratio.** Divide the chin measurement by the philtrum measurement. A result between 1.0 and 1.3 is generally considered balanced.
...
![Anatomical diagram of lower face landmarks used to measure philtrum length and chin height](/blog/facial-harmony-guide/3.webp)
...
For a more personalized assessment that accounts for your specific proportions rather than generic advice, [Aura](https://app.aura-looksmaxxing.com) generates a custom improvement plan based on your facial scans, including specific weak points and actionable recommendations.
