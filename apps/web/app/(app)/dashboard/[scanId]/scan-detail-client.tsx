...
function MetricRow({ label, value, tooltip }: { label: string; value: number; tooltip: string }) {
  return (
    <div>
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 space-y-3">
          ...
          <MetricRow label="Gonial Angle" value={scan.gonialAngleScore} tooltip={TOOLTIPS.gonialAngle} />
          <MetricRow label="Midface Ratio" value={scan.midfaceRatioScore} tooltip={TOOLTIPS.midfaceRatio} />
          <MetricRow label="Cheekbone Prominence" value={scan.cheekboneScore} tooltip={TOOLTIPS.cheekbone} />
        ...
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 space-y-3">
          ...
          <MetricRow label="Canthal Tilt" value={scan.canthalTiltScore} tooltip={TOOLTIPS.canthalTilt} />
          <MetricRow label="Upper Eyelid Exposure" value={scan.upperEyelidScore} tooltip={TOOLTIPS.upperEyelid} />
          <MetricRow label="Interpupillary Distance" value={scan.ipdScore} tooltip={TOOLTIPS.ipd} />
        ...
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 space-y-3">
          ...
          <MetricRow label="Skin Clarity" value={scan.skinClarityScore} tooltip={TOOLTIPS.skinClarity} />
          <MetricRow label="Hairline" value={scan.hairlineScore} tooltip={TOOLTIPS.hairline} />
        ...
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 space-y-3">
          ...
          <MetricRow label="Asymmetry Index" value={scan.symmetryScore} tooltip={TOOLTIPS.symmetry} />
